...
| [Versioning](https://docs.aws.amazon.com/AmazonS3/latest/dev/Versioning.html) | Learn about Amazon S3's Versioning capabilities\. | 
...
| [Object Lifecycle Management](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html) | Learn how to manage the lifecycle of objects in your bucket\. Lifecycle management includes expiring objects and archiving objects \(transitioning objects to the GLACIER storage class\)\. | 